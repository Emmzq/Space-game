...
class GameScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("planetGreen", './assets/images/PlanetNoRings.png');
    ...
    create() {
        ...
        this.planetGreen = new BackgroundItems(this, 1, "planetGreen");
        ...
        this.ufo = new Player(this, 'ufo', this.bullet, 'GameScene');
        ...
        // Create asteroids, meteorites and emeralds
    ...
    update(time, delta) { // In update it is defined how the ufo moves
        ...
        while (this.timer > 1000) { // I got help with this using source 8. 
            ...
            if (this.timeLeft <= 0) {
                this.timeLeft = 6000
                let score = this.ufo.player.score 
                this.ufo.player.score = 0
                this.scene.start('NextLevelScene', { Score: score });
            }
        }
        ...
        // ASTEROIDS movement updates and asteroid-player collision detector
        this.asteroid.movement()
